...
HD_PWD='C:/Users/reese/OneDrive/Documents/University/EEE4120F/YODA_V2/YODA_V2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Input_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Input_module.tcl -notrace
