...
HD_PWD='C:/Users/reese/OneDrive/Documents/University/EEE4120F/YODA_V2/YODA_V2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Input_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Input_module.tcl
